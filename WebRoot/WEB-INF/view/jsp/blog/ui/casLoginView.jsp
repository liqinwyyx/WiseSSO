...
<div class="container">
	...
	<form:form cssClass="form-signin" method="post" id="fm1"
		...
		<input type="text" class="form-control captcha" id="captcha"
			name="authcode" placeholder="验证码" tabindex="3" type="text">
		<img align="middle" id="kaptcha" src="${pageContext.request.contextPath}/verify.do" >
...
<script type="text/javascript">
	$(function(){
		$('#changeCaptcha').click(     
			        function() {     
			           $("#kaptcha").hide().attr('src','${pageContext.request.contextPath}/verify.do?' + Math.floor(Math.random() * 100)).fadeIn();     
			    });
	});
